...
import SmartTabletSlider from '../components/smartTabletSlider';

const ProductDetailsTablets = ({route, navigation}) => {
  const id = route.params.tabletId; // get the item object passed from the previous screen
...
export default ProductDetailsTablets;
